# Epoxy-Bonded Steel Plate Retrofitting in RC Beams — Prediction App [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.16889615.svg)](https://doi.org/10.5281/zenodo.16889615)
...
1. Place your files in this folder:
   ...
   - Artifacts: `final_extratrees_model.pkl`, `scaler.pkl`, `top_features.json`
...
### D. Add the DOI badge
After Zenodo finishes, edit this README and add the badge Zenodo provides:
```markdown
...
@software{kholil_rcbeam_2025,
  author       = {Md. Ibrahim Kholil and Md. Waliul Islam and Muhammad Harunur Rashid and Aziz Ahmed},
...
If citing the **paper** (after acceptance), add the final citation here.
...
- **Model weights & scaler**: MIT or CC BY 4.0 (update if different).

---

## 5) Reproducibility Notes

- The scaler expects features **exactly in the order** in `top_features.json`.  
- The model was trained on the dataset referenced in the paper.  
- For deterministic runs, set `PYTHONHASHSEED` and pin versions in `requirements.txt`.
...
*M. I. Kholil, M. W. Islam, M. H. Rashid, and A. Ahmed, “Epoxy-Bonded Steel Plate Retrofitting in RC Beams — Prediction App,” v1.0.0, 2025. Zenodo. doi:10.5281/zenodo.XXXXXXX.*
...
- **Md. Ibrahim Kholil** — Postgraduate Student, Department of Civil Engineering, Khulna University of Engineering & Technology (KUET), Khulna, Bangladesh.  
  ✉️ [engikholil@gmail.com](mailto:engikholil@gmail.com) | [ORCID](https://orcid.org/0000-0002-3349-8496)

- **Md. Waliul Islam** — Graduate, Department of Civil Engineering, Khulna University of Engineering & Technology (KUET), Khulna, Bangladesh.  
  ✉️ [noyon038@gmail.com](mailto:noyon038@gmail.com)

- **Professor Muhammad Harunur Rashid** — Department of Civil Engineering, KUET, Khulna, Bangladesh.  
  ✉️ [mhrashid@ce.kuet.ac.bd](mailto:mhrashid@ce.kuet.ac.bd)

- **Aziz Ahmed** — Senior Lecturer, School of Civil, Mining, Environmental and Architectural Engineering, University of Wollongong, Australia.  
  ✉️ [aziza@uow.edu.au](mailto:aziza@uow.edu.au) | [ORCID](https://orcid.org/0000-0001-9707-2606)

---

## References

- Kholil, M. I., Islam, M. W., Rashid, M. H., & Ahmed, A. (2025). *Debonding in Epoxy-Bonded Steel-Plated RC Beams: Cohesive Zone Modeling and Machine Learning Prediction.* Manuscript under preparation; DOI pending.
